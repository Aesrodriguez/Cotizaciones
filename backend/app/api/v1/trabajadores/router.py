...
def _trab_out(t: Trabajador, resumen: dict) -> TrabajadorOut:
    return TrabajadorOut(
        ...
        tipo_documento=getattr(t, 'tipo_documento', None),
        fecha_nacimiento=getattr(t, 'fecha_nacimiento', None),
        genero=getattr(t, 'genero', None),
        estado_civil=getattr(t, 'estado_civil', None),
        nivel_educativo=getattr(t, 'nivel_educativo', None),
        eps=getattr(t, 'eps', None),
        fondo_pension=getattr(t, 'fondo_pension', None),
        arl=getattr(t, 'arl', None),
        caja_compensacion=getattr(t, 'caja_compensacion', None),
        numero_hijos=getattr(t, 'numero_hijos', None),
