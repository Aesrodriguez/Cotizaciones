        ...
        <div style={{ padding: '8px 32px 20px' }}>
          ...
          <div style={{ display: 'flex', justifyContent: 'flex-end' }}>
            <table style={{ minWidth: '240px' }}>
              <tbody>
                <tr><td style={{ padding: '3px 8px', color: '#64748b' }}>Subtotal:</td><td style={{ padding: '3px 8px', textAlign: 'right' }}>{formatCurrency(quote.subtotal, quote.moneda)}</td></tr>
                {Number(quote.descuento) > 0 && <tr><td style={{ padding: '3px 8px', color: '#dc2626' }}>Descuento:</td><td style={{ padding: '3px 8px', textAlign: 'right', color: '#dc2626' }}>- {formatCurrency(quote.descuento, quote.moneda)}</td></tr>}
                <tr><td style={{ padding: '3px 8px', color: '#64748b' }}>IVA:</td><td style={{ padding: '3px 8px', textAlign: 'right' }}>{formatCurrency(quote.impuesto, quote.moneda)}</td></tr>
